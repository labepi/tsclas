...
cmd = 'cat ../../../results/asos/1min/res_asos_2020_jan_'+span+'_D'+D+'.txt | grep PREDICTED | grep "_'+timeint+'"'

#cmd = 'cat ../../../results/asos/1min/res_asos_2020_jan_1week_D3.txt | grep PREDICTED | grep "_5min"'
...
#labels = ['Temperature', 'Wind Direction', 'Wind Speed', 'Pressure']
labels = ['Temp.', 'Wind\nDirection', 'Wind\nSpeed', 'Pressure']
...
fname =  'img/fig_heat_'+span+'_D'+D+'_'+timeint+'.pdf'
plt.savefig(fname)
